...
#define ACT_HOLD_BUTT_SLIDE_NO_CANCEL  0x010008BF // (0x0BF | ACT_FLAG_AIR | ACT_FLAG_ALLOW_VERTICAL_WIND_ACTION)
...
#define ACT_DEATH_REVIVE               0x0002033E // (0x13E | ACT_FLAG_STATIONARY | ACT_FLAG_INVULNERABLE)
