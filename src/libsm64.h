...
extern SM64_LIB_FN void sm64_set_mario_angle(int32_t marioId, float angle);
...
extern SM64_LIB_FN void sm64_set_mario_floor_override(int32_t marioId, uint16_t terrain, int16_t floorType, int16_t floorForce);
